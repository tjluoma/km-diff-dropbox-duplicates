...
then
	...
	# which 'diff' command do you want to use? Could also be function or
	# some other app's diff command. I use bbdiff because BBEdit is my
	# supreme editor of the universe.
